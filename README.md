...
**ZapCRM** é uma plataforma completa de gestão de relacionamento com clientes (CRM) que ajuda equipes de vendas a serem mais produtivas e organizadas.

### Por que escolher ZapCRM?
...
Para a versão focada na venda e entrega do white-label, veja também:

- [`docs/manual-do-comprador-whitelabel.md`](./docs/manual-do-comprador-whitelabel.md)
- [`docs/instalacao-whitelabel-github-vercel.md`](./docs/instalacao-whitelabel-github-vercel.md)
- [`docs/suporte-instalacao-whitelabel.md`](./docs/suporte-instalacao-whitelabel.md)
...
1. Acesse o repositório: [github.com/villelatypebot/zapcrm](https://github.com/villelatypebot/zapcrm)
2. Clique no botão **Fork** (canto superior direito)
3. Escolha sua conta pessoal ou organização
4. Aguarde o fork ser criado

> ✅ **Pronto quando**: Você ver o repositório `zapcrm` na sua conta do GitHub
...
4. Na lista de repositórios, encontre e selecione **zapcrm** (seu fork)
5. Clique em **Deploy**

> ⏱️ **Aguarde**: O deploy leva cerca de 2-3 minutos

6. Quando terminar, você verá uma mensagem de sucesso
7. **Copie a URL** do seu projeto (ex: `https://zapcrm-abc123.vercel.app`)
...
2. **Prepare suas credenciais**
   ...
   **a) Token da Vercel:**
   ...
   - Dê um nome (ex: "ZapCRM Installer")
...
O ZapCRM tem estas áreas principais:
...
O ZapCRM tem dois tipos de usuários:
...
- 🐛 **Problemas**: Abra uma [issue no GitHub](https://github.com/villelatypebot/zapcrm/issues)
...
git clone https://github.com/villelatypebot/zapcrm.git
cd zapcrm
...
- **Lucas Villela** - *Integracao WhatsApp, LeadScoring, Memória e I.A*
- **Thales Laray** - *Desenvolvimento Inicial do CRM*
