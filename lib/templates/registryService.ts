 ...
 * de um registro local do projeto, permitindo templates pré-configurados
...
/**
 * URL base do registro local de templates.
 * @constant
 */
const REGISTRY_BASE_URL = '/template-registry';

/**
 * Busca o índice de templates disponíveis.
 * 
 * O índice contém metadados sobre todos os templates de jornada
 * disponíveis no registro local, incluindo nome, descrição e caminho.
 * 
