...
const ACTION_LABELS: Record<string, string> = {
  ...
  WHITELABEL_BRANDING_UPDATED: 'White-Label Atualizado',
  TENANT_OPERATION_UPDATED: 'Operação do Tenant Atualizada',
  TENANT_BLUEPRINT_APPLIED: 'Blueprint do Tenant Aplicado',
};
